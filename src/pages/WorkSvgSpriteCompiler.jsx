...
export default function WorkSvgSpriteCompiler() {
  return (
    <motion.div 
    ...
    <footer className="site-footer">
      <div>
        ...
        <a className="footer-cta route-link" href="mailto:YOUR_EMAIL">Let’s make the complex feel clear.</a>
      </div>
      <div className="footer-meta">
        ...
        <span className="footer-views">Views: <strong id="visitor-count" style={{"color":"var(--accent)","fontWeight":"600"}}>1,138</strong></span>
