...
export default function Mascot() {
  ...
  const uxTips = [
    ...
    "Purvaj builds for the web, front to back, and is still studying.",
    "Good design isn't about having the cleverest answer. It's about asking the right questions.",
    "Got something to build? Use the discuss link up top.",
    "Try dragging the sticky notes on the homepage to clear your path!",
    "Every project here started as a thing that did not exist yet.",
    "Ask about the stack. There is always a reason behind the choice.",
    "My eyes follow your cursor. Try dragging the sticky notes too.",
