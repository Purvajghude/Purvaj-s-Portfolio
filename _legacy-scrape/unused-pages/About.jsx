...
export default function About() {
  ...
  <div className="page about-page">
    <motion.section className="page-hero grid-paper reveal revealed" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="phase-chip"><span>02</span> My perspective</div>
      <h1>The person behind<br />the process.</h1>
      <p>A formal bio on the left. The honest version in the margins.</p>
      <span className="scribble" aria-hidden="true">look closer ↓</span>
    </motion.section>
    
    <motion.section className="section bio-section reveal revealed" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="portrait-board">
        <div className="portrait-placeholder">
          <img src="/purvaj-portrait.png" alt="Portrait of Purvaj Ghude" />
          <p>strategist<br />listener<br />maker</p>
        </div>
        <span className="portrait-tape"></span>
        <p className="portrait-caption">Usually somewhere between a whiteboard and a difficult question.</p>
      </div>
      <div className="bio-copy">
        <p className="lede">I’m a UX Manager who believes clarity is one of the kindest things a product can offer.</p>
        <div className="bio-columns">
          <p>At YOUR_EMPLOYER, I lead experience design across BoldDesk and BoldAgent. My work spans product strategy, research systems, interaction design, and growing the craft and confidence of a design team.</p>
          <p>I came to UX through video editing, which taught me rhythm, narrative, and the discipline of removing what doesn’t serve the story. Those lessons still show up in every workflow I simplify.</p>
        </div>
        <div className="reflection">
          <span>Honestly?</span>
          I don’t think design is about having the cleverest answer in the room. It’s about creating the conditions for the right answer to become obvious.
        </div>
      </div>
    </motion.section>

    <motion.section className="section beliefs reveal" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="section-kicker"><span>Research findings</span><i></i><span>What I believe</span></div>
      <div className="finding-grid">
        <article><span>Finding 01</span><h3>Clarity beats cleverness.</h3><p>A user should never have to admire an interface before they can understand it.</p></article>
        <article><span>Finding 02</span><h3>Evidence is a team sport.</h3><p>Research matters most when it becomes shared language, not a private report.</p></article>
        <article><span>Finding 03</span><h3>Leadership is environmental design.</h3><p>Shape the context well and good decisions become easier for everyone.</p></article>
        <article><span>Finding 04</span><h3>Systems should leave room for judgment.</h3><p>Consistency creates trust. Flexibility protects the human moment.</p></article>
      </div>
    </motion.section>

    <motion.section className="section personality-section grid-paper reveal" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div>
        <p className="hand-note">A highly unscientific readout</p>
        <h2>Quietly curious.<br />Seriously collaborative.</h2>
      </div>
      <div className="trait-chart">
        
            <div className="trait"><div><span>Listener</span><span>Talker</span></div><div className="trait-line" style={{"--value":"82%"}}><i style={{"left":"82%"}}></i></div></div>
            <div className="trait"><div><span>Systems</span><span>Surprises</span></div><div className="trait-line" style={{"--value":"70%"}}><i style={{"left":"70%"}}></i></div></div>
            <div className="trait"><div><span>Evidence</span><span>Instinct</span></div><div className="trait-line" style={{"--value":"64%"}}><i style={{"left":"64%"}}></i></div></div>
            <div className="trait"><div><span>Deep work</span><span>Quick wins</span></div><div className="trait-line" style={{"--value":"77%"}}><i style={{"left":"77%"}}></i></div></div>
      </div>
    </motion.section>

    <motion.section className="section now-section reveal" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="section-heading"><div><p className="eyebrow">Field notes</p><h2>Currently...</h2></div></div>
      <div className="now-grid">
        <article className="sticky-yellow"><small>Reading</small><strong>The Making of a Manager</strong><p>Julie Zhuo</p></article>
        <article className="sticky-blue"><small>Listening</small><strong>How I Built This</strong><p>with Guy Raz</p></article>
        <article className="sticky-pink"><small>Thinking about</small><strong>How AI changes design critique</strong><p>Notes in progress...</p></article>
      </div>
    </motion.section>
    ...
    <footer className="site-footer">
      ...
      <div className="footer-meta">
        ...
        <span className="footer-views">Views: <strong id="visitor-count" style={{"color":"var(--accent)","fontWeight":"600"}}>1,130</strong></span>
