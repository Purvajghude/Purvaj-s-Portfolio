...
export default function Blog() {
  ...
  <div className="page blog-page">
    <motion.section className="page-hero grid-paper reveal revealed" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="phase-chip"><span>04</span> Reflecting on the craft</div>
      <h1>Notes from<br />the messy middle.</h1>
      <p>Things I’m learning about products, teams, research, and the space between them.</p>
      <span className="scribble" aria-hidden="true">look closer ↓</span>
    </motion.section>
    
    <motion.section className="blog-board reveal revealed" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="board-string"><span>Product &amp; craft</span></div>
      <div className="post-grid">
        
            <Link to="/blog/figma-design-system" className="post-note sticky-yellow route-link bound" style={{"--r":"-2deg"}}>
              <span className="post-pin"></span><small>Design systems · 8 min</small><h2>Building a Figma design system that teams actually use</h2><p>A practical approach to semantic variables, component architecture, and driving engineering adoption without getting stuck in the coverage trap.</p><time>Jun 08, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/automation-workflow-ai-agentic" className="post-note sticky-blue route-link bound" style={{"--r":"1.5deg"}}>
              <span className="post-pin"></span><small>AI &amp; systems · 7 min</small><h2>Automation vs workflow vs AI vs agentic systems</h2><p>Moving past the marketing jargon: a clear, operational breakdown of rules-based logic versus goal-driven autonomous systems.</p><time>Jun 01, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/ai-agent-skill-md" className="post-note sticky-pink route-link bound" style={{"--r":"-1deg"}}>
              <span className="post-pin"></span><small>AI craft · 9 min</small><h2>How to write a useful AI agent skill file in Markdown</h2><p>Structuring .md skill files so AI agents know exactly when to trigger them, what constraints to follow, and how to verify their own work.</p><time>May 25, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/cricbuzz-ux-case-study" className="post-note sticky-green route-link bound" style={{"--r":"2deg"}}>
              <span className="post-pin"></span><small>UX case study · 10 min</small><h2>UX case study: making Cricbuzz easier to scan</h2><p>A structural teardown of live sports app UX, focusing on information architecture, progressive disclosure, and reducing cognitive load during live events.</p><time>May 12, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/designing-for-trust-in-ai" className="post-note sticky-yellow route-link bound" style={{"--r":"1deg"}}>
              <span className="post-pin"></span><small>AI UX · 6 min</small><h2>Designing for trust before designing for delight</h2><p>Moving beyond the polished happy path to design for calibrated trust, graceful failures, and clear human-in-the-loop handoffs.</p><time>May 18, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/manager-as-a-mirror" className="post-note sticky-blue route-link bound" style={{"--r":"-1.5deg"}}>
              <span className="post-pin"></span><small>Leadership · 4 min</small><h2>A design manager should be a mirror, not a map</h2><p>Shifting from directing solutions to facilitating critical thinking using Socratic questioning during design critiques.</p><time>Apr 02, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/support-software-human" className="post-note sticky-pink route-link bound" style={{"--r":"2.5deg"}}>
              <span className="post-pin"></span><small>Product · 7 min</small><h2>What makes support software feel human?</h2><p>Reducing cognitive load for support agents so they have the mental capacity to provide empathetic, human-centric customer service.</p><time>Feb 11, 2026</time><i>Read note →</i>
            </Link>
            <Link to="/blog/small-research-habits" className="post-note sticky-green route-link bound" style={{"--r":"-2.5deg"}}>
              <span className="post-pin"></span><small>Research · 5 min</small><h2>Five small research habits that compound</h2><p>Integrating continuous discovery into your weekly rhythm without relying on massive, slow research projects.</p><time>Dec 08, 2025</time><i>Read note →</i>
            </Link>
      </div>
    </motion.section>
    ...
    <footer className="site-footer">
      ...
      <div className="footer-meta">
        ...
        <span className="footer-views">Views: <strong id="visitor-count" style={{"color":"var(--accent)","fontWeight":"600"}}>1,132</strong></span>
