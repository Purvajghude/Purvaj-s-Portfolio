...
export default function Mentoring() {
  ...
  <div className="page mentoring-page">
    <motion.section className="page-hero grid-paper reveal revealed" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="phase-chip"><span>06</span> Growing together</div>
      <h1>1:1 UX Design &amp;<br />AI Mentoring</h1>
      <p>Personalized mentoring to help you grow in UX Design, Figma, portfolio building, interview preparation, and AI-powered design workflows.<br /><br /><a href="#mentoring-plans" className="button" style={{"marginTop":"1rem"}}>Book Your Session</a></p>
      <span className="scribble" aria-hidden="true">look closer ↓</span>
    </motion.section>
    
    <motion.section className="section mentoring-plans reveal revealed" id="mentoring-plans" initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <div className="pricing-grid" style={{"display":"grid","gridTemplateColumns":"repeat(auto-fit, minmax(280px, 1fr))","gap":"2rem","marginTop":"2rem"}}>
        
        <div className="pricing-card" style={{"border":"2px solid var(--border)","padding":"2rem","borderRadius":"8px","background":"var(--surface)"}}>
          <h3 style={{"fontFamily":"var(--display)","fontSize":"1.5rem","marginBottom":"0.5rem"}}>🚀 Quick Guidance</h3>
          <div style={{"fontSize":"2rem","fontFamily":"var(--mono)","fontWeight":"bold","marginBottom":"0.25rem"}}>₹199</div>
          <div style={{"color":"var(--muted)","marginBottom":"1.5rem"}}>25 Minutes</div>
          
          <div style={{"marginBottom":"2rem"}}>
            <p style={{"fontWeight":"bold","marginBottom":"1rem"}}>Perfect for:</p>
            <ul style={{"listStyleType":"none","padding":"0","display":"flex","flexDirection":"column","gap":"0.5rem"}}>
              <li>✓ Quick UX questions</li>
          ...
          <a href="https://calendar.app.google/NjT39ibqYT3YGNiu7" target="_blank" rel="noopener noreferrer" className="button" style={{"width":"100%","display":"flex","justifyContent":"center"}}>Book 25-Min Session</a>
        </div>

        <div className="pricing-card featured" style={{"border":"2px solid var(--ink)","padding":"2rem","borderRadius":"8px","background":"var(--highlight)","position":"relative"}}>
          <h3 style={{"fontFamily":"var(--display)","fontSize":"1.5rem","marginBottom":"0.5rem"}}>⭐ Deep Dive Mentoring</h3>
          <div style={{"fontSize":"2rem","fontFamily":"var(--mono)","fontWeight":"bold","marginBottom":"0.25rem"}}>₹499</div>
          <div style={{"color":"var(--ink)","opacity":"0.8","marginBottom":"1.5rem"}}>60 Minutes</div>
          
          <div style={{"marginBottom":"2rem"}}>
            <p style={{"fontWeight":"bold","marginBottom":"1rem"}}>Focus areas (choose 1-2):</p>
            <ul style={{"listStyleType":"none","padding":"0","display":"flex","flexDirection":"column","gap":"0.5rem"}}>
              <li>✓ In-depth portfolio review</li>
              <li>✓ UX case study guidance</li>
              <li>✓ Interview preparation</li>
              <li>✓ UX &amp; AI mentoring</li>
              <li>✓ Personalized learning roadmap</li>
              <li>✓ Career growth discussion</li>
            </ul>
          </div>
          
          <a href="https://calendar.app.google/NjT39ibqYT3YGNiu7" target="_blank" rel="noopener noreferrer" className="button button-ink" style={{"width":"100%","display":"flex","justifyContent":"center"}}>Book 60-Min Session</a>
        </div>

      </div>
    </motion.section>

    <motion.section className="section mentoring-faq reveal" style={{"marginTop":"4rem"}} initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} viewport={{once: true}} transition={{type: "spring", stiffness: 120, damping: 14, mass: 0.8}}>
      <h2 style={{"fontFamily":"var(--display)","fontSize":"2rem","marginBottom":"2rem"}}>Frequently Asked Questions</h2>
      
      <div className="faq-list" style={{"display":"flex","flexDirection":"column","gap":"1.5rem"}}>
        <div className="faq-item">
          <h3 style={{"fontSize":"1.25rem","marginBottom":"0.5rem"}}>Who is this mentoring for?</h3>
          <p style={{"color":"var(--muted)"}}>Students, aspiring UX designers, career switchers, and professionals looking to level up their UX skills.</p>
        </div>
        
        <div className="faq-item">
          <h3 style={{"fontSize":"1.25rem","marginBottom":"0.5rem"}}>Are the sessions personalized?</h3>
          <p style={{"color":"var(--muted)"}}>Yes. Every session is tailored to your goals and experience level.</p>
        </div>
        
        <div className="faq-item">
          <h3 style={{"fontSize":"1.25rem","marginBottom":"0.5rem"}}>Which plan should I choose?</h3>
          <p style={{"color":"var(--muted)"}}>Choose the 25-minute session for quick guidance or the 60-minute session for detailed mentoring and feedback.</p>
        </div>
        
        <div className="faq-item">
          <h3 style={{"fontSize":"1.25rem","marginBottom":"0.5rem"}}>Can I book more than one session?</h3>
          <p style={{"color":"var(--muted)"}}>Yes, you can book multiple sessions based on your learning needs.</p>
        </div>
      </div>
    </motion.section>
    ...
    <footer className="site-footer">
      ...
      <div className="footer-meta">
        ...
        <span className="footer-views">Views: <strong id="visitor-count" style={{"color":"var(--accent)","fontWeight":"600"}}>1,135</strong></span>
